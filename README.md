...
Персональный, self-hosted дневной трекер. Многопользовательский: вход по паролю,
данные каждого изолированы. Учётки выдаёт администратор — завести аккаунт самому
нельзя.
